...
αλλοίωση των σημάτων κατα την διαδικασία καταγραφής τους. Για τον λόγο
αυτό συνήθως εφαρμόζεται ένα φίλτρο χαμηλών συχνοτήτων ή φίλτρο κατά της
αλλοίωσης (anti-aliasing filters ([AAF])).


[AAF] <https://en.wikipedia.org/wiki/Anti-aliasing_filter>
...
$$x (n ) = 5 sin\times \frac{2\pi \times 1000n }{8000} + cos \times (\frac{2\pi \times 2500n }{8000})$$, (12.8)
...
είναι η καθυστέρηση της αρχής της ακολουθίας x[•] κατά Μ, και να λύθει
...
** TODO Multi rate Digital signal processing
